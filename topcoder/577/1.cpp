...
double EllysRoomAssignmentsDiv1::getAverage(vector <string> ratings) {
	...
	int N = v.size(), R = (N%20 ? N/20+1 : N/20);
	printf("N:%d\tR:%d\n", N, R);
	if(N%20 == 0)
	{
		int z = index/R, t = 0;
		...
		return (double)(s-t+erating)/(double)((N/R-1)*R);
	}
	else
	{
		int z = (N/R)*R;
		...
		else
		{
			...
			printf("Returning %d * %d / %d / %d\n", s-t+erating, N%R, N/R, R);
			return (double)(s-t+erating)*(double)(N%R)/(double)((N/R)*R);
		}
	}
...
double test0() {
	string t0[] = {"1924 1242 1213 1217 2399 1777 2201 2301 1683 2045 ", "1396 2363 1560 2185 1496 2244 2117 2207 2098 1319 ",
		"2216 1223 1256 2359 2394 1572 2151 2191 2147 2253 ", "1633 2217 2211 1591 1310 1209 1430 1445 1988 2030 ",
		"1947 1202 1203"};
	vector <string> p0(t0, t0+sizeof(t0)/sizeof(string));
	EllysRoomAssignmentsDiv1 * obj = new EllysRoomAssignmentsDiv1();
	clock_t start = clock();
	double my_answer = obj->getAverage(p0);
	clock_t end = clock();
	delete obj;
	cout <<"Time: " <<(double)(end-start)/CLOCKS_PER_SEC <<" seconds" <<endl;
	double p1 = 1821.3291005291007;
...
double test2() {
	string t0[] = {"2367 1395 1639 1842 1426 2393 2348 1571 2077 12", "2", "2 1966 1495 13",
...
double test3() {
	string t0[] = {"2869 3239 1609 2367 1836 1663 1697 2317 1475 2212 ", "2188 2073 1263 1391 1495 3010 1243 2198 1782 1564 ",
